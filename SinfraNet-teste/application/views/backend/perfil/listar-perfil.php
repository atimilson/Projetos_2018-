<div class="container">
    ...
    <div class="btn-input input-space form-row">       
        <input type="text" id="filtro" onkeyup="searchPerfil()" placeholder="Selecionar Filtro ao Lado">
    </div>
                    ...
                    <div class="form-group">
                      ...
                      <table class="perfilTable">
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[1]" class="error"  <?php if($perfil->noticia != null && $perfil->noticia != 0){echo 'checked';} ?>/>
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[2]" class="error" <?php if($perfil->evento != null && $perfil->evento != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[3]" class="error" <?php if($perfil->repositorio != null && $perfil->repositorio != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[4]" class="error"  <?php if($perfil->acessos != null && $perfil->acessos != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[5]" class="error" <?php if($perfil->servico != null && $perfil->servico != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[6]" class="error" <?php if($perfil->fotos != null && $perfil->fotos != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[7]" class="error" <?php if($perfil->videos != null && $perfil->videos != 0){echo 'checked';} ?>/>
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[8]" class="error"  <?php if($perfil->audios != null && $perfil->audios != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[9]" class="error" <?php if($perfil->aniversario != null && $perfil->aniversario != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[10]" class="error"  <?php if($perfil->ramal != null && $perfil->ramal != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[11]" class="error"  <?php if($perfil->enquete != null && $perfil->enquete != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[12]" class="error" <?php if($perfil->usuario != null && $perfil->usuario != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[13]" class="error" <?php if($perfil->perfil != null && $perfil->perfil != 0){echo 'checked';} ?> />
                                </div>
                            </td>
                            <td>
                                <div style="display: inline-flex;">
                            ...
                            <td>
                                <div>
                                    <input id="perfilCheck" type="checkbox" name="check[14]" class="error" <?php if($perfil->setor != null && $perfil->setor != 0){echo 'checked';} ?> />
                                </div>
