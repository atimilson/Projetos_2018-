 ...
 ?>
    ...
    <div class="titulo-listar">
       <?php
        ...
        <div class="listar-noticias">Notícias Cadastradas: <?php echo count($noticias_todos) ?> </div>
        <div class="listar-noticias">Notícias Publicadas: <?php echo $publicado ?></div>
        <div class="listar-noticias">Notícias não Publicadas: <?php echo $npublicado ?></div>
        ...
        <div class="col-md-3 spaceNoticia" id="noticia-<?php echo $noticia_todos->id ?>">
                <div>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content tamanho-modal">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-check">
                                        <label>
                                            <input type="checkbox" name="check[2]" <?php if($noticia_todos->posicao_tres != null && $noticia_todos->posicao_tres != 0){echo 'checked';} ?>> <span class="label-text">Três Notícias</span>
                                            <img src="<?php echo base_url('assets/backend/imagens/') ?>tres.svg" width="150" height="100"/>               
                                    </div> 

                                    <div class="form-check">
                                        <label>
                                            <input type="checkbox" name="check[3]" <?php if($noticia_todos->posicao_quadro != null && $noticia_todos->posicao_quadro != 0){echo 'checked';} ?>> <span class="label-text">Quatro Notícias</span>
                    ...
                    <div class="limite-texto">
                        <p><?php echo substr($noticia_todos->titulo, 0, 18) . "..." ?></p> 
                        <p><i><?php echo substr($noticia_todos->subtitulo, 0, 27) . "..." ?></i></p>
                    </div>
                </div>
