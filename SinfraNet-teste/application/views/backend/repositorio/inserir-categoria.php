<div class="container">
    ...
    <?php if (isset($_SESSION['excluido'])) { ?>
        <script>
        var mensagem = "<strong>Aniversário excluido com sucesso!</strong>";
    ...
    <div class="btn-input input-space form-row">
        <select id="selecione" class="select-estilo">
            ...
            <option value="dataNasc">Nome</option>            
        </select>
        <input type="text" id="filtro-aniver" onkeyup="search_aniver()" placeholder="Selecionar Filtro ao Lado">        
    </div>
    ...
    <table class="table table-responsive" id="tableAniver" style="border-collapse: separate;
        ...
        <thead class="titulos-tabela">
            <tr>
                ...
                <th class="centro">Nº DOCUMENTOS</th>                
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                    
                        ...
                        ?>
                        <!--                        <div class="form-group">
                                                    <label class="label-modal" for="nome">Documento</label>
                                                    <input type="file" class="form-control" id="icone-modal" name="icone"/>
                                                </div>-->
                        <div class="form-group">
                            <label class="label-modal" for="dataNasc">Nome</label>
                            <input type="text" class="form-control" id="nome-doc" name="nomeDoc" placeholder="Nome da Categoria"/>
                        </div>
                        <!--                        <div class="form-group">
                                                    <label class="label-modal" for="setor">Categoria</label>
                                                    <select class="form-control" name="setor">
