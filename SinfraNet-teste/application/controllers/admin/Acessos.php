...
class Acessos extends CI_Controller {
    ...
    public function alterar() {
        ...
        $this->form_validation->set_rules('nome_sistema', 'nome', 'required|max_length[80]');
        $this->form_validation->set_rules('url', 'url', 'required|max_length[80]');
//        $this->form_validation->set_rules('icone', 'icone', 'required');
    ...
    public function salvar() {
        ...
        $this->form_validation->set_rules('nome-acesso', 'nome-acesso', 'required|max_length[80]');
        $this->form_validation->set_rules('url', 'url', 'required|max_length[80]');
//        $this->form_validation->set_rules('icone', 'icone', 'required');
