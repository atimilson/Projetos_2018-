...
public class CadastroUsuarioGUI extends javax.swing.JDialog {
    ...
    public CadastroUsuarioGUI(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);

        UsuarioDAO usuario = new UsuarioDAO();
        UsuarioVO usuarioAdd = usuario.selecionarUsuario(id);
        ...
        if (usuarioAdd != null) {
            ...
            jTextFieldNome2.setText(usuarioAdd.getNome());
            jTextFieldEndereco.setText(usuarioAdd.getEndereco());
            jFormattedTextFieldCPF.setText(usuarioAdd.getCpf());
            jFormattedTextFieldRG.setText(usuarioAdd.getRg());
            jFormattedTextFieldTelefone.setText(usuarioAdd.getTelefone());
        }
    ...
    private void initComponents() {
        ...
        jTextFieldEndereco.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTextFieldEnderecoMouseClicked(evt);
            }
        });
        ...
        jFormattedTextFieldTelefone.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jFormattedTextFieldTelefoneMouseClicked(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jTextFieldNome2, javax.swing.GroupLayout.Alignment.LEADING))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblMsgObrigatorioNome)
                    .addComponent(jTextFieldNome2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jFormattedTextFieldCPF, jFormattedTextFieldRG, jFormattedTextFieldTelefone, jTextFieldEndereco, jTextFieldLogin, jTextFieldNome2, jTextFieldSenha});
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        controller.usuario.setNome(jTextFieldNome2.getText());
        controller.usuario.setCpf(jFormattedTextFieldCPF.getText());
        controller.usuario.setRg(jFormattedTextFieldRG.getText());
        controller.usuario.setEndereco(jTextFieldEndereco.getText());
        controller.usuario.setTelefone(jFormattedTextFieldTelefone.getText());
        controller.usuario.setLogin(jTextFieldLogin.getText());
        controller.usuario.setSenha(jTextFieldSenha.getText());

        if (idEditar == 0) {
            verifica();
            dispose();
        } else {
            controller.editar(controller.usuario, idEditar);
            dispose();
        }
    ...
    private void jTextFieldEnderecoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextFieldEnderecoMouseClicked
        // TODO add your handling code here:
        lblMsgObrigatorioEndereco.setVisible(false);
    }//GEN-LAST:event_jTextFieldEnderecoMouseClicked

    private void jFormattedTextFieldTelefoneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jFormattedTextFieldTelefoneMouseClicked
        // TODO add your handling code here:
        lblMsgObrigatorioTel.setVisible(false);
    }//GEN-LAST:event_jFormattedTextFieldTelefoneMouseClicked
    ...
    public void verifica() {
        if (jTextFieldNome2.getText().length() > 0) {
            lblMsgObrigatorioNome.setVisible(false);

            if (!jFormattedTextFieldCPF.getText().trim().equals("-")) {
                lblMsgObrigatorioCpf.setVisible(false);

                if (!jFormattedTextFieldRG.getText().trim().equals("-")) {
                    lblMsgObrigatorioRg.setVisible(false);
                        ...
                        if (!jFormattedTextFieldTelefone.getText().equals("(  )     -    ")) {
                            ...
                            if ((jTextFieldLogin.getText().length() > 0)) {
                                ...
                                if (jTextFieldSenha.getText().length() > 0) {
                                    ...
                                    System.out.println(jTextFieldNome2);

                                    FabricaConexao conexao = new FabricaConexao();
                                    UsuarioController usuario = new UsuarioController();

                                    usuario.usuario.setNome(jTextFieldNome2.getText());
                                    ...
                                    try {
                                        ...
                                        try {
                                            //abrindo coexao com o banco de dados
                                            conexao.abreConexao();

                                            //comando sql para mandar ap banco 
                                            String sql = "select login_user from usuario";

                                            //cria o statement para podermos enviar o sql
                                            conexao.stmt = (Statement) conexao.conn.createStatement();

                                            //execulta o sql e armazena no resultSet
                                            conexao.rs = conexao.stmt.executeQuery(sql);

                                            while (conexao.rs.next()) {
                                                userBanco = conexao.rs.getString("login_user");

                                                if (jTextFieldLogin.getText().equals(userBanco)) {
                                                    testaUser = 1;
